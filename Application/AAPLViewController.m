...
- (IBAction)OnEnableVolumeLightingButton:(NSButton *)sender {
    [_renderer OnEnableVolumeLightingButton:sender];
}
- (IBAction)OnLightLatitudeSlider:(NSSlider *)sender {
    [_renderer OnLightLatitudeSlider:sender];
}
- (IBAction)OnLightAltitudeSlider:(NSSlider *)sender {
    [_renderer OnLightAltitudeSlider:sender];
}
- (IBAction)OnStepSizeSlider:(NSSlider *)sender {
    [_renderer OnStepSizeSlider:sender];
}
- (IBAction)OnVolumeLightingBlur:(NSButton *)sender {
    [_renderer OnBlurButton:sender];
}
@end
